 ...
 * @link        https://github.com/bramus/router/blob/master/src/Bramus/Router/Router.php
 */
...
class BramusRouter
{
    ...
    */
    ...
    {
        if (is_callable($fn)) {
            $fnReturn = call_user_func_array($fn, $params);
            if (is_string($fnReturn)) echo $fnReturn;
        }
            ...
            try {
                ...
                if ($reflectedMethod->isPublic() && (!$reflectedMethod->isAbstract())) {
                    if ($reflectedMethod->isStatic()) {
                        $fnReturn = forward_static_call_array(array($controller, $method), $params);
                        if (is_string($fnReturn)) echo $fnReturn;
                    } else {
                        ...
                        $fnReturn = call_user_func_array(array($controller, $method), $params);
                        if (is_string($fnReturn)) echo $fnReturn;
                    }
                }
